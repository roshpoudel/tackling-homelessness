...
def home_page_layout() -> html.Div:
    return html.Div([
        html.H3('Home', style={'text-align': 'center'}),
...
def first_tab_layout() -> html.Div:
    ...
    return html.Div([
        html.H3('Demographics in PIT and PVA', style={'text-align': 'center', 'margin-bottom': '20px'}),
...
def second_tab_layout() -> html.Div:
    ...
    return html.Div([
        html.H3('Explore the PVA Dataset', style={'text-align': 'center', 'margin-bottom': '20px'}),
...
class ThirdTab:
    ...
    def third_tab_layout(cls) -> html.Div:
        ...
        return html.Div([
            html.Div([
                html.H3('Findings', style={'text-align': 'center', 'margin-bottom': '20px'}),
                html.P('Here are our findings from our analysis on the PVA dataset'),
                html.H4('Overall Scores Distribution'),
                html.Hr(),
                html.P('The overall scores distribution for the PVA dataset is as follows:'),
                dcc.Graph(id='findings-pva-graph', figure=tab_3_graphs.overall_scores_distribution()),
            ...
            html.P('The following tabs contain the findings for each of the sub-scores in the PVA dataset'),
            html.Hr(),
    ...
    def lothomeless_content() -> html.Div:
        return html.Div([
            ...
            dcc.Graph(id='findings-lothomeless-graph', figure=tab_3_graphs.lot_homeless_graphs.lot_homeless_graph1()),
            ...
            dcc.Graph(id='findings-lothomeless-graph2', figure=tab_3_graphs.lot_homeless_graphs.lot_homeless_graph2()),
            html.P("Males (both BIPOC and White) reported higher rates of 8+ years of homelessness."),
            dcc.Graph(id='findings-lothomeless-graph3', figure=tab_3_graphs.lot_homeless_graphs.lot_homeless_graph3()),
            html.P("BIPOC Females had the highest reported rate of under one year of homelessness."),
            dcc.Graph(id='findings-lothomeless-graph4', figure=tab_3_graphs.lot_homeless_graphs.lot_homeless_graph4()),
    ...
    def healthscale_content() -> html.Div:
        return html.Div([
            ...
            dcc.Graph(id='findings-healthscale-graph', figure=tab_3_graphs.health_scale_graphs.health_scale_graph1()),
            dcc.Graph(id='findings-healthscale-graph2', figure=tab_3_graphs.health_scale_graphs.health_scale_graph2()),
            html.P("White Females report Poor health at a disporportionately high rate."),
        ], style={'padding': '20px'})
    ...
    def risksandbarriers_content() -> html.Div:
        return html.Div([
            ...
            dcc.Graph(id='findings-risksandbarriers-graph', figure=tab_3_graphs.risks_and_barriers_graphs.risks_and_barriers_graph1()),
            ...
            dcc.Graph(id='findings-risksandbarriers-graph2', figure=tab_3_graphs.risks_and_barriers_graphs.risks_and_barriers_graph2()),
            ...
            dcc.Graph(id='findings-risksandbarriers-graph3', figure=tab_3_graphs.risks_and_barriers_graphs.risks_and_barriers_graph3()),
            ...
            dcc.Graph(id='findings-risksandbarriers-graph4', figure=tab_3_graphs.risks_and_barriers_graphs.risks_and_barriers_graph4()),
            html.P("Questions in this section garner more skips than questions in other sections.")
        ], style={'padding': '20px'})
    ...
    def householdtype_content() -> html.Div:
        return html.Div([
            ...
            dcc.Graph(id='findings-householdtype-graph', figure=tab_3_graphs.household_type_graphs.household_type_graph1()),
            html.P("The median score is equal across demographic groups at 1."),
            dcc.Graph(id='findings-householdtype-graph2', figure=tab_3_graphs.household_type_graphs.household_type_graph2()),
            html.P("The above graph shows total 96 'yes' responses across all demographic categories."),
            ...
            dcc.Graph(id='findings-householdtype-graph3', figure=tab_3_graphs.household_type_graphs.household_type_graph3()),
            dcc.Graph(id='findings-householdtype-graph4', figure=tab_3_graphs.household_type_graphs.household_type_graph4()),
            dcc.Graph(id='findings-householdtype-graph5', figure=tab_3_graphs.household_type_graphs.household_type_graph5()),
            ...
            dcc.Graph(id='findings-householdtype-graph5', figure=tab_3_graphs.household_type_graphs.household_type_graph6()),
            dcc.Graph(id='findings-householdtype-graph6', figure=tab_3_graphs.household_type_graphs.household_type_graph7()),
            html.P("The distribution of scores in this category does not match the distribution of related answers."),
    ...
    def livingsituation_content() -> html.Div:
        return html.Div([
            ...
            dcc.Graph(id='findings-livingsituation-graph', figure=tab_3_graphs.living_situation_graphs.living_situation_graph1()),
            dcc.Graph(id='findings-livingsituation-graph2', figure=tab_3_graphs.living_situation_graphs.living_situation_graph2()),
            dcc.Graph(id='findings-livingsituation-graph3', figure=tab_3_graphs.living_situation_graphs.living_situation_graph3()),
...
def fourth_tab_layout() -> html.Div:
    return html.Div([
        html.H3('Recommendation and Report', style={'text-align': 'center', 'margin-bottom': '20px'}),
